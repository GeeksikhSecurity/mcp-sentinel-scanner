...
class MLClassifier:
    ...
    def predict_false_positive(self, finding: VulnerabilityFinding, context: Dict[str, bool]) -> Tuple[bool, float]:
    ...
    def _extract_features(self, finding: VulnerabilityFinding, context: Dict[str, bool]) -> Dict[str, float]:
    ...
    def filter_findings(self, findings: List[VulnerabilityFinding]) -> List[VulnerabilityFinding]:
        ...
        for finding in findings:
            context = {
                ...
                "has_test_prefix": any(prefix in finding.code_snippet for prefix in ["MOCK_", "TEST_", "EXAMPLE_"]),
